 ...
 */
export async function bootstrap(mode, opts) {
    ...
    coordinator.onDecisionChange((ctx) => {
        if (ctx.permission?.allowed === false)
            metrics.blockedTriggers += 1;
    });
